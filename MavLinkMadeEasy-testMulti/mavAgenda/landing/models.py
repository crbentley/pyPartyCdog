...
degree_choices = (
    ...
    ('doctrate of science', 'DOCTRATE OF SCIENCE'),
)
major_choices = (
    ('computer science', 'COMPUTER SCIENCE'),
    ('more majors coming soon', 'MORE MAJORS COMING SOON'),
)
classtaken_choices = (
    ('csci3100', 'CSCI 3100'),
    ('csci3000', 'CIST 3000'),
...
class User(models.Model):
    ...
    classtaken = MultiSelectField(choices=classtaken_choices, max_choices=100, max_length=100)
    def __str__(self):
        return self.email
